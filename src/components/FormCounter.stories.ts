...
const Template2 = (args) => ({
  ...
  // And then the `args` are bound to your component with `v-bind="args"`
  template: '<FormKit v-bind="args"><template #decrease>minus</template><template #increase>plus</template></FormKit>'
});

export const Counter = Template.bind({});
export const CustomCounter = Template2.bind({});
